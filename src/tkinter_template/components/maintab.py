...
from tkinter_template.components.jmespath_live import JmesPathLiveFrame
...
class MainTab(ttk.Notebook):
    def __init__(self, root: tk.BaseWidget, config: Config, **kwds):
        ...
        self.jmes_path = self._add_to_tab('JMESPath Live', JmesPathLiveFrame(self))
    ...
    def subscribe(self, st: State):
        ...
        self.jmes_path.subscribe(st.jmes_path_state)
